...
const RESOURCES = [
  ...
  },
  {
    ...
    icon: '📋',
    url: 'https://www.csa.gov.sg/our-programmes/support-for-enterprises/sg-cyber-safe-for-enterprises/cybersecurity-self-assessment',
    color: '#22c55e',
    tag: 'Self-Help Tool',
  },
  {
    ...
    icon: '🏥',
    url: 'https://www.csa.gov.sg/our-programmes/support-for-enterprises/sg-cyber-safe-for-enterprises/cybersecurity-health-check',
    color: '#06b6d4',
  ...
  },
  {
    ...
    icon: '🧰',
    url: 'https://www.csa.gov.sg/our-programmes/support-for-enterprises/sg-cyber-safe-toolkits',
    color: '#f97316',
    tag: 'Free Resource',
  },
  {
    ...
    icon: '👔',
    url: 'https://www.csa.gov.sg/our-programmes/support-for-enterprises/sg-cyber-safe-for-enterprises/ciso-as-a-service',
    color: '#a855f7',
